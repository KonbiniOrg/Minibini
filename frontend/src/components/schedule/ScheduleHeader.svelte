...
<style>
  ...
  .lane-label-spacer {
    ...
    justify-content: space-between; box-sizing: border-box; padding: 0 4px;
  }
  .today-btn {
  ...
  /* ‹ › flank the Today button at the edges of the TODAY container, pushing
     the day axis (.days) to start at the cleaner left edge. */
  .nav {
