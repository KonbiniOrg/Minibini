...
from apps.jobs.models import ServicePrice, Job, Task, PlanTask
...
class ValidateDataServicePriceTest(TestCase):
    ...
    def test_flags_negative_rate_flat_fee(self):
        ServicePrice.objects.create(
            name='Neg rate flat', algorithm=ServicePrice.FLAT_FEE,
    ...
    def test_flags_dict_active_modifiers_on_task(self):
        ...
        Task.objects.filter(pk=Task.objects.create(
            name='Bad task', job=job, service_price=sp,
            active_modifiers=[],
    ...
    def test_flags_dict_active_modifiers_on_plan_task(self):
        ...
        PlanTask.objects.filter(pk=PlanTask.objects.create(
            name='Bad plan task', est_worksheet=ws, service_price=sp,
    ...
    def test_valid_list_active_modifiers_not_flagged(self):
        ...
        Task.objects.create(
            name='Good task', job=job, service_price=sp,
