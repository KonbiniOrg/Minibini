...
class GenerateTaskEstWorksheetBranchTest(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.template = TaskTemplate.objects.create(
            template_name='T-gtw', service_item=self.scheme,
    ...
    def test_generate_task_for_worksheet_propagates_scheme(self):
        ...
        self.assertEqual(pt.service_item, self.scheme)
...
class EffectiveACPropertyTest(BaseTestCase):
    ...
    def test_task_effective_ac_comes_from_service_item(self):
        from apps.jobs.models import Task
        job = self._make_job()
        t = Task.objects.create(job=job, name='t', service_item=self.scheme)
    ...
    def test_taskTemplate_effective_ac_comes_from_scheme(self):
        ...
        tt = TaskTemplate.objects.create(
            template_name='tt-eac', service_item=self.scheme,
...
class AddTaskManualRequiresSchemeTest(BaseTestCase):
    ...
    def test_add_task_manual_with_scheme_succeeds(self):
        ...
        self.assertEqual(pt.service_item_id, self.scheme.pk)
