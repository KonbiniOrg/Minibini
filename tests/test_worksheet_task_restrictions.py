...
class WorksheetTaskRestrictionTests(TestCase):
    ...
    def test_can_add_task_to_draft_worksheet(self):
        ...
        url = reverse('estimates:task_add_from_template', args=[self.draft_worksheet.est_worksheet_id])
        ...
        self.assertRedirects(
            response,
            reverse('estimates:estworksheet_detail', args=[self.draft_worksheet.est_worksheet_id])
        )
    ...
    def test_cannot_add_task_from_template_to_final_worksheet(self):
        ...
        self.assertRedirects(
            response,
            reverse('estimates:estworksheet_detail', args=[self.final_worksheet.est_worksheet_id])
        )
    ...
    def test_cannot_add_task_from_template_to_superseded_worksheet(self):
        ...
        url = reverse('estimates:task_add_from_template', args=[self.superseded_worksheet.est_worksheet_id])
        ...
        self.assertRedirects(
            response,
            reverse('estimates:estworksheet_detail', args=[self.superseded_worksheet.est_worksheet_id])
        )
    ...
    def test_cannot_add_task_manually_to_final_worksheet(self):
        ...
        url = reverse('estimates:task_add_manual', args=[self.final_worksheet.est_worksheet_id])
    ...
    def test_cannot_add_task_manually_to_superseded_worksheet(self):
        ...
        url = reverse('estimates:task_add_manual', args=[self.superseded_worksheet.est_worksheet_id])
    ...
    def test_task_addition_links_hidden_for_final_worksheet(self):
        ...
        url = reverse('estimates:estworksheet_detail', args=[self.final_worksheet.est_worksheet_id])
        response = self.client.get(url)
    ...
    def test_can_add_task_manually_to_draft_worksheet(self):
        ...
        url = reverse('estimates:task_add_manual', args=[self.draft_worksheet.est_worksheet_id])
...
class WorksheetTaskWorkflowTests(TestCase):
    ...
    def test_task_addition_blocked_after_worksheet_finalization(self):
        ...
        url = reverse('estimates:task_add_from_template', args=[worksheet.est_worksheet_id])
        response = self.client.post(url, {
            'template': self.task_template.template_id,
            'est_qty': '1.0'
        })
        ...
        self.assertRedirects(
            response,
            reverse('estimates:estworksheet_detail', args=[worksheet.est_worksheet_id])
        )
