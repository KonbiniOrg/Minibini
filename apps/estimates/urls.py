...
urlpatterns = [
    ...
    path('<int:estimate_id>/create-work-order/', views.work_order_create_from_estimate, name='work_order_create_from_estimate'),
    ...
    path('templates/<int:template_id>/edit/', views.work_order_template_edit, name='work_order_template_edit'),
    path('templates/<int:template_id>/delete/', views.work_order_template_delete, name='work_order_template_delete'),
